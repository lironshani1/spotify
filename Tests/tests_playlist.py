...
class Test_playlist:
    ...
    def test_add_song_success(self, get_url, get_tests_data):
        ...
        playlist_logic.add_song_to_playlist(url=urljoin(get_url, "/playlists/add_song"), json=get_tests_data["add_song_to_playlist"])
        user_logic.get_user(url=urljoin(get_url, "/users/get_user"), user_name=get_tests_data["new_user"]["user_name"])
